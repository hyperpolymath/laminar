...
git clone <https://github.com/hyperpolymath/laminar.git> cd laminar
...
toolbox create laminar-dev toolbox enter laminar-dev \# Install
...
laminar/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/laminar/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/laminar/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/laminar/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/laminar/labels/perimeter-3) — Community sandbox scope
