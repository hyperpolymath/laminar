...
doctor:
    @echo "Running diagnostics for laminar..."
...
heal:
    @echo "Attempting auto-repair for laminar..."
...
help-me:
    ...
    @echo "  https://github.com/hyperpolymath/laminar/issues/new"
    @echo ""
