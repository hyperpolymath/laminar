...
// Replace laminar, Laminar — See README.adoc for details., just run, Laminar started successfully. with actuals
= laminar — Quick Start for Users
:toc:
:toclevels: 2

== What is laminar?

Laminar — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./laminar-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/laminar/wiki
