...
:experimental:
:url-github: https://github.com/hyperpolymath/laminar
:url-gitlab: https://gitlab.com/hyperpolymath/laminar
:url-bitbucket: https://bitbucket.org/hyperpolymath/laminar
:url-codeberg: https://codeberg.org/hyperpolymath/laminar

Laminar flow orchestration for data pipelines
...
laminar is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
